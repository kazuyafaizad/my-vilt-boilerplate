...
const classes = computed(() => {
    return props.active
        ...
        : 'block w-full pl-3 pr-4 py-2 border-l-4 border-transparent text-left text-base font-medium text-gray-600 hover:text-base-content hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-base-content focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out';
});
</script>
